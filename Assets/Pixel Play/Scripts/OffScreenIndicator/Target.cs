...
public class Target : MonoBehaviour
{
    ...
    [SerializeField] private bool needNameText = true;

    [Tooltip("change if distance text is required for this target")]
    [SerializeField] private string nameText = "";

    [Tooltip("change if description text is required for this target")]
    [SerializeField] private string urlText = "";
    /// <summary>
